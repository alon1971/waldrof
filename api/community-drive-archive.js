...
function buildCommunitySummarySystemPrompt() {
  return [
    ...
    'כתוב בעברית פדגוגית עשירה, רהוטה ומדויקת — לא רשימות דלות, לא תקציר שטחי, ולא דילוג על חלקים מרכזיים מהמקורות.',
...
function buildCommunitySummaryTextPreamble(query, options, fileBundles, mediaMeta) {
  ...
  return [
    ...
    '',
    'הפק סיכום פדגוגי עמוק, מקיף, מפורט ומאוחד של החומרים הבאים — לא תקציר קצר.',
